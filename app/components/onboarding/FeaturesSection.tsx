      ...
      {[
        {
          ...
          icon: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--inv-t)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.56 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg>,
        },
        {
          title: 'Send 20% offer', sub: 'CUST-3302 · Score 61',
          badge: 'Med', bStyle: { background: 'rgba(180,83,9,.1)', color: '#B45309' },
          icon: <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--inv-t)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 12V22H4V12" /><path d="M22 7H2v5h20V7z" /><path d="M12 22V7" /></svg>,
        },
